...
## To Do
#	refactor to use _draw_element functions to create each element centered on a point (given as arg)
#	refactor to calc constants on resize where possible
#	add option to use images as elements
